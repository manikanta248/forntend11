...
export default function AllTasks(props) {
    ...
    const loadTaskData = async () => {
        try {
            const response = await fetch("https://backend-3-llpw.onrender.com/api/taskdataload", {
                method: 'POST',
                headers: {
    ...
    const handleUpdate = async () => {
        try {
            const response = await fetch(`https://backend-3-llpw.onrender.com/api/updatetask/${editedTask._id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const handleDelete = async (taskId) => {
        try {
            const response = await fetch(`https://backend-3-llpw.onrender.com/api/deletetask/${taskId}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
                }
